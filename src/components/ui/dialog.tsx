			...
			>
				...
				{showClose ? (
					<DialogPrimitive.Close
						className="absolute top-4 right-4 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2 disabled:pointer-events-none dark:ring-offset-neutral-950"
						aria-label="Close"
					>
						<X className="size-4" />
					</DialogPrimitive.Close>
